...
void CgenClassTable::generate_tac()
{
  ...
  if (cgen_debug) cout << "generating tac for object initializers" << endl;
  generate_tac_for_object_initializers();
  
  if (cgen_debug) cout << "generating tac for object methods" << endl;
